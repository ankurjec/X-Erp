                    ...
                    <div class="expense_row row">
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control entity_type_select">
                                    ...
                                    <option value="general_expense" @if($credit_note->type == "general_expense")
                                        selected="selected" @endif>General Expense</option>
                                    <option value="vendor_payment" @if($credit_note->type == "vendor_payment")
                                        selected="selected" @endif>Vendor Payment</option>
                                    <option value="refunds" @if($credit_note->type == "refunds") selected="selected"
                                        @endif>Refunds</option>
                                </select>
                            </div>
                        </div>
                        ...
                        {{-- <div class="col-xs-3 col-sm-3 col-md-3 user_id_select_box" style="display:none">
                            <div class="form-group">
                                ...
                                <select name="user_id" class="form-control user_id_select">
                                    ...
                                    @if($user->id > 1)
                                    <option value="{{$user->id}}" @if($expense->user_id == $user->id)
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 vendor_id_select_box" style="display:none">
                            <div class="form-group">
                                ...
                                <select name="vendor_id" class="form-control vendor_id_select select2">
                                    ...
                                    <option value="{{$vendor->id}}" @if($credit_note->vendor_id == $vendor->id)
                                        selected="selected" @endif>{{$vendor->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 customer_id_select_box" style="display:none">
                            <div class="form-group">
                                ...
                                <select name="customer_id" class="form-control customer_id_select select2">
                                    ...
                                    <option value="{{$customer->id}}" @if($credit_note->customer_id == $customer->id)
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" step="0.01" name="amount" class="form-control"
                                    placeholder="Amount" value="{{$credit_note->amount}}">
                            </div>
                        </div>
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="details"
                                    placeholder="Detail">{!!$credit_note->details!!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-check">
                                <input name="paid_flag" class="form-check-input" type="checkbox" value="1"
                                    id="paid_flag" @if($credit_note->paid_flag) checked="checked" @endif>
