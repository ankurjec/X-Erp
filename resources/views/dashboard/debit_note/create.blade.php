...
<div class="c-subheader px-3">
    ...
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="/expenses">Manage Debit Note</a></li>
        <li class="breadcrumb-item active">Add Debit Note</li>
        <!-- Breadcrumb Menu-->
    </ol>
</div>
@endsection
