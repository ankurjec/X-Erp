...
<div class="c-subheader px-3">
          ...
          <ol class="breadcrumb border-0 m-0">
            ...
            <li class="breadcrumb-item active">Edit Debit Notes</li>
            <!-- Breadcrumb Menu-->
          </ol>
</div>
@endsection
...
<div class="container-fluid">
    ...
    <form action="{{ route('debit_note.update',$debit_note->id) }}" method="POST">
    	@csrf
        @method('PUT')
         ...
         <div class="expense_row row">
		    ...
		    <div class="col-xs-2 col-sm-2 col-md-2">
		        <div class="form-group">
		            ...
		            <input type="number" min="1" step="0.01" name="amount" class="form-control" placeholder="Amount" value="{{$debit_note->amount}}">
		        </div>
		    </div>
		    ...
		    <div class="col-xs-4 col-sm-4 col-md-4">
		        <div class="form-group">
		            ...
		            <textarea class="form-control" name="details" placeholder="Detail">{!!$debit_note->details!!}</textarea>
		        </div>
		    </div>
		    ...
		    <div class="col-xs-4 col-sm-4 col-md-4">
		        <div class="form-check">
                  <input name="paid_flag" class="form-check-input" type="checkbox" value="1" id="paid_flag" @if($debit_note->paid_flag) checked="checked" @endif>
